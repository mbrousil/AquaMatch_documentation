...
If you use this data harmonization pipeline or the associated code in your research, please cite it as follows:

> Brousil, M. R., Steele, B. G., De La Torre, J., Willi, K., & Ross, M. R. V. (2026). *AquaMatch data harmonization process* [Technical Documentation]. ROSSyndicate. https://aquasat.github.io/AquaMatch_documentation/

**BibTeX:**
```bibtex
@manual{brousil2026aquamatch,
  title={AquaMatch data harmonization process},
  author={Brousil, Matthew R. and Steele, Bethel G. and De La Torre, Juan and Willi, Katie and Ross, Matthew R.V.},
  year={2026},
  organization={ROSSyndicate},
  url={[https://aquasat.github.io/AquaMatch_documentation/](https://aquasat.github.io/AquaMatch_documentation/)}
}
```