...
#' 
retrieve_data <- function(target, id_df, local_folder, stable = TRUE, 
  ...
  # Get file contents of the Google Drive folder specified. Append "stable/"
  # to go to the subfolder.
